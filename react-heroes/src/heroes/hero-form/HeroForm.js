		...
		<div className="card w-half">
			<form onSubmit={handleFormSubmission} autoComplete="off">
				...
				<div className="form-group">
					<label htmlFor="hero-name" className="required text-muted">
						Name
					</label>
					<input
						type="text"
				...
				<div className="form-group">
					...
					<textarea
						...
						id="hero-description"
						placeholder="Write a short description about this hero."
						required="required"
				...
				>
					<FontAwesomeIcon icon={faBan} className="cancel-btn-icon" />{' '}
					Cancel
				</button>
			</form>
		</div>
